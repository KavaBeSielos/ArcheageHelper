...
//JWT Secret
const jwtSecret = "9827990735496asui.sapf2/aso,k;alsniwas761174584293"
...
UserSchema.methods.generateAccessAuthToken = function() {
    ...
    return new Promise((resolve, reject) => {
        // Create the JWT (JSON WEB TOKEN) and return it
...
UserSchema.methods.generateRefreshAuthToken = function () {
    // generates refresh auth token of 64byt hex string - it doesn't save it to db. saveSessionToDatabase() does that.
    return new Promise((resolve, reject) => {
